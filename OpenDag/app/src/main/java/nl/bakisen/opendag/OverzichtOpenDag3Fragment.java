...
public class OverzichtOpenDag3Fragment extends Fragment {
    int counter = 1;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_overzichtopendag3
                , container, false);
...
//        past overige informatie aan dat aansluit op de titel
        ...
        agenda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                long startMillis = 0;
                long endMillis = 0;
                beginTime.set(2020,5,10,16,55);
                startMillis = beginTime.getTimeInMillis();
                Calendar endTime = calendarEvent.getInstance();
                endTime.set(2020,5,10,20,00);
