        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (inputemail.getText().toString().trim().matches(emailPattern)
                    ...
                    home.commit();
                }else {if(inputemail.getText().toString().isEmpty()|| inputquestion.getText().toString().isEmpty()||(inputfirstName.getText().toString().isEmpty()||(inputlastName.toString().isEmpty()))) {
