...
public class Mailontvangen3Fragment extends Fragment {
    ImageButton instaKnop, faceKnop, twitterKnop;
    Button home, agenda;

    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_mailontvangen3, container, false);

        home = (Button) view.findViewById(R.id.backtohome);
        agenda = (Button) view.findViewById(R.id.calender_button3);
        ...
        twitterKnop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String twitter = "https://twitter.com/intent/tweet?text=Ik ga naar de open dag van hogeschool rotterdam op 11 april!&original_referer=";
