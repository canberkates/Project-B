...
//                commopen2.replace(R.id.fragment_container, new ...());
...
//                Infopen2.replace(R.id.fragment_container, new ...());
...
//                CMDopen2.replace(R.id.fragment_container, new ...());
...
//                techopen2.replace(R.id.fragment_container, new ...());
...
//                cmgtopen2.replace(R.id.fragment_container, new ...());
