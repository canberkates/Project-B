...
public class OpenDag1TechnischeInformaticaFragment extends Fragment {
    int counter = 1;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_overzichtopendag1technischeinformatica, container, false);
